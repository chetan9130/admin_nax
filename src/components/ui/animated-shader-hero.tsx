...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-purple-950 ${className}`}>
      <style>{`
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button 
                  ...
                  className="px-8 py-4 bg-white hover:bg-white/90 text-purple-950 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-white/25"
                >
...
void main(void) {
	...
	for (float i=1.; i<12.; i++) {
		...
		vec2 p=uv;
		float d=length(p);
		col+=.00125/d*(cos(sin(i)*vec3(0.3,0.15,0.5))+1.);
